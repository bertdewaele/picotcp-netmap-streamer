...
deps: deps/picotcp deps/netmap
	cd deps/picotcp;      make IPV6=0 NAT=0 MCAST=1 IPFILTER=0 DNS_CLIENT=0 SNTP_CLIENT=0 DHCP_CLIENT=0 DHCP_SERVER=0 HTTP_CLIENT=0 HTTP_SERVER=0 OLSR=0 SLAACV4=0 IPFRAG=0 DEBUG=1 TCP=1 UDP=1
